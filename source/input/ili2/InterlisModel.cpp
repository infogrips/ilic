...
string input::getInterlisModel23()
{
   ...
   source += "      ILIC_BOOLEAN (FINAL) = (\n";
   source += "         false,\n";
   source += "         true) ORDERED;\n";
   source += "      ILIC_HALIGNMENT (FINAL) = (\n";
   source += "         Left,\n";
   source += "         Center,\n";
   source += "         Right) ORDERED;\n";
   source += "      ILIC_VALIGNMENT (FINAL) = (\n";
   source += "         Top,\n";
   source += "         Cap,\n";
   source += "         Half,\n";
   source += "         Base,\n";
   ...
   source += "   FUNCTION isSubClass (potSubClass: STRUCTURE; potSuperClass: STRUCTURE):ILIC_BOOLEAN;\n";
   source += "   FUNCTION isOfClass (Object: ANYSTRUCTURE; Class: STRUCTURE): ILIC_BOOLEAN;\n";
   ...
   source += "   FUNCTION isEnumSubVal (SubVal: ENUMTREEVAL; NodeVal: ENUMTREEVAL): ILIC_BOOLEAN;\n";
