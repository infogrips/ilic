...
void ImdOutput::visitDocText(DocText *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "DocText", get_path(t));
...
void ImdOutput::visitMetaAttribute(MetaAttribute *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "MetaAttribute", get_path(t));
...
void ImdOutput::visitMetaElement(MetaElement *t) // ABSTRACT
{
...
void ImdOutput::visitExtendableME(ExtendableME *t) // ABSTRACT
{
...
void ImdOutput::visitPackage(Package *t) // ABSTRACT
{
   visitMetaElement(t);
}
...
void ImdOutput::visitImport(Import *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Import", get_path(t));
...
void ImdOutput::visitIli1Format(Ili1Format *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Ili1Format", get_path(t));
...
void ImdOutput::visitModel(Model *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Model", get_path(t));
...
void ImdOutput::visitSubModel(SubModel *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "SubModel", get_path(t));
...
void ImdOutput::visitType(Type *t) // ABSTRACT
{
...
void ImdOutput::visitMultiplicity(Multiplicity *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Multiplicity", get_path(t));
...
void ImdOutput::visitConstraint(Constraint *t) // ABSTRACT
{
...
void ImdOutput::visitDomainType(DomainType *t) // ABSTRACT
{
...
void ImdOutput::visitClass(Class *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Class", get_path(t));
...
void ImdOutput::visitAttrOrParam(AttrOrParam *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "AttrOrParam", get_path(t));
...
void ImdOutput::visitTypeRelatedType(TypeRelatedType *t) // ABSTRACT
{
...
void ImdOutput::visitTypeRestriction(TypeRestriction *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "TypeRestriction", get_path(t));
...
void ImdOutput::visitMultiValue(MultiValue *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "MultiValue", get_path(t));

   visitTypeRelatedType(t);
...
void ImdOutput::visitClassRelatedType(ClassRelatedType *t) // ABSTRACT
{
...
void ImdOutput::visitBaseClass(BaseClass *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "BaseClass", get_path(t));
...
void ImdOutput::visitClassRestriction(ClassRestriction *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "ClassRestriction", get_path(t));
...
void ImdOutput::visitReferenceType(ReferenceType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "ReferenceType", get_path(t));

   visitClassRelatedType(t);
...
void ImdOutput::visitRole(Role *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Role", get_path(t));
...
void ImdOutput::visitExplicitAssocAccess(ExplicitAssocAccess *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "ExplicitAssocAccess", get_path(t));
...
void ImdOutput::visitAssocAcc(AssocAcc *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "AssocAcc", get_path(t));
...
void ImdOutput::visitTransferElement(TransferElement *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "TransferElement", get_path(t));
...
void ImdOutput::visitIli1TransferElement(Ili1TransferElement *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Ili1TransferElement", get_path(t));
...
void ImdOutput::visitDataUnit(DataUnit *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "DataUnit", get_path(t));
...
void ImdOutput::visitDependency(Dependency *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Dependency", get_path(t));
...
void ImdOutput::visitAllowedInBasket(AllowedInBasket *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "AllowedInBasket", get_path(t));
...
void ImdOutput::visitContext(Context *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Context", get_path(t));
...
void ImdOutput::visitGenericDef(GenericDef *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "GenericDef", get_path(t));
...
void ImdOutput::visitUnit(Unit *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Unit", get_path(t));
...
void ImdOutput::visitMetaBasketDef(MetaBasketDef *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "MetaBasketDef", get_path(t));
...
void ImdOutput::visitMetaObjectDef(MetaObjectDef *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "MetaObjectDef", get_path(t));
...
void ImdOutput::visitBooleanType(BooleanType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "BooleanType", get_path(t));
...
void ImdOutput::visitTextType(TextType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "TextType", get_path(t));
...
void ImdOutput::visitBlackboxType(BlackboxType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "BlackboxType", get_path(t));
...
void ImdOutput::visitNumType(NumType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "NumType", get_path(t));
...
void ImdOutput::visitCoordType(CoordType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "CoordType", get_path(t));
...
void ImdOutput::visitAxisSpec(AxisSpec *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "AxisSpec", get_path(t));
...
void ImdOutput::visitNumsRefSys(NumsRefSys *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "NumsRefSys", get_path(t));
...
void ImdOutput::visitFormattedType(FormattedType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "FormattedType", get_path(t));
...
void ImdOutput::visitAnyOIDType(AnyOIDType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "AnyOIDType", get_path(t));
...
void ImdOutput::visitFunctionDef(FunctionDef *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "FunctionDef", get_path(t));
...
void ImdOutput::visitArgument(Argument *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Argument", get_path(t));
...
void ImdOutput::visitClassRefType(ClassRefType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "ClassRefType", get_path(t));
...
void ImdOutput::visitObjectType(ObjectType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "ObjectType", get_path(t));
...
void ImdOutput::visitAttributeRefType(AttributeRefType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "AttributeRefType", get_path(t));
...
void ImdOutput::visitARefRestriction(ARefRestriction *t) // ABSTRACT ???, to do !!!
{

   xtf.openObject(getMetaModel(version), "ModelData", "ARefRestriction", get_path(t));
...
void ImdOutput::visitEnumType(EnumType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "EnumType", get_path(t));
...
void ImdOutput::visitEnumNode(EnumNode *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "EnumNode", get_path(t));
...
void ImdOutput::visitEnumTreeValueType(EnumTreeValueType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "EnumTreeValueType", get_path(t));
...
void ImdOutput::visitLineForm(LineForm *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "LineForm", get_path(t));
...
void ImdOutput::visitLineType(LineType *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "LineType", get_path(t));
...
void ImdOutput::visitLinesForm(LinesForm *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "LinesForm", get_path(t));
...
void ImdOutput::visitView(View *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "View", get_path(t));
...
void ImdOutput::visitRenamedBaseView(RenamedBaseView *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "RenamedBaseView", get_path(t));
...
void ImdOutput::visitExpression(Expression *t) // ABSTRACT
{
...
void ImdOutput::visitUnaryExpr(UnaryExpr *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "UnaryExpr", get_path(t));
...
void ImdOutput::visitCompoundExpr(CompoundExpr *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "CompoundExpr", get_path(t));
...
void ImdOutput::visitFactor(Factor *t) // ABSTRACT
{
   visitExpression(t);
}
...
void ImdOutput::visitPathEl(PathEl *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "PathEl", get_path(t));
...
void ImdOutput::visitPathOrInspFactor(PathOrInspFactor *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "PathOrInspFactor", get_path(t));
...
void ImdOutput::visitEnumAssignment(EnumAssignment *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "EnumAssignment", get_path(t));
...
void ImdOutput::visitEnumMapping(EnumMapping *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "EnumMapping", get_path(t));
...
void ImdOutput::visitClassRef(ClassRef *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "ClassRef", get_path(t));
...
void ImdOutput::visitActualArgument(ActualArgument *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "ActualArgument", get_path(t));
...
void ImdOutput::visitFunctionCall(FunctionCall *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "FunctionCall", get_path(t));
...
void ImdOutput::visitRuntimeParamRef(RuntimeParamRef *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "RuntimeParamRef", get_path(t));
...
void ImdOutput::visitConstant(Constant *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Constant", get_path(t));
...
void ImdOutput::visitClassConst(ClassConst *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "ClassConst", get_path(t));
...
void ImdOutput::visitAttributeConst(AttributeConst *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "AttributeConst", get_path(t));
...
void ImdOutput::visitUnitRef(UnitRef *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "UnitRef", get_path(t));
...
void ImdOutput::visitUnitFunction(UnitFunction *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "UnitFunction", get_path(t));
...
void ImdOutput::visitSimpleConstraint(SimpleConstraint *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "SimpleConstraint", get_path(t));
...
void ImdOutput::visitExistenceDef(ExistenceDef *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "ExistenceDef", get_path(t));

   visitPathOrInspFactor(t);
...
void ImdOutput::visitExistenceConstraint(ExistenceConstraint *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "ExistenceConstraint", get_path(t));
...
void ImdOutput::visitUniqueConstraint(UniqueConstraint *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "UniqueConstraint", get_path(t));
...
void ImdOutput::visitSetConstraint(SetConstraint *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "SetConstraint", get_path(t));
...
void ImdOutput::visitGraphic(Graphic *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Graphic", get_path(t));
...
void ImdOutput::visitSignParamAssignment(SignParamAssignment *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "SignParamAssignment", get_path(t));
...
void ImdOutput::visitCondSignParamAssignment(CondSignParamAssignment *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "CondSignParamAssignment", get_path(t));
...
void ImdOutput::visitDrawingRule(DrawingRule *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "DrawingRule", get_path(t));
...
void ImdOutput::visitDocTextTranslation(DocTextTranslation *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "DocTextTranslation", get_path(t));
...
void ImdOutput::visitMETranslation(METranslation *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "METranslation", get_path(t));
...
void ImdOutput::visitTranslation(Translation *t)
{
   ...
   xtf.openObject(getMetaModel(version), "ModelData", "Translation", get_path(t));
