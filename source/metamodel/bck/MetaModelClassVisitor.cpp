...
#include "MetaModelClassVisitor.h"
#include "../util/Logger.h"

namespace metamodel {

// forward declarations
static void visitModel(MetaModelClassVisitor *visitor, Model *m);
static void visitSubModel(MetaModelClassVisitor *visitor, SubModel *m);
static void visitConstraint(MetaModelClassVisitor *visitor, Constraint *c);
static void visitContext(MetaModelClassVisitor *visitor, Context *c);
static void visitMetaObjectDef(MetaModelClassVisitor *visitor, MetaObjectDef *d);
static void visitFunctionDef(MetaModelClassVisitor *visitor, FunctionDef *f);
static void visitArgument(MetaModelClassVisitor *visitor, Argument *a);
static void visitLineForm(MetaModelClassVisitor *visitor, LineForm *f);
static void visitAttrOrParam(MetaModelClassVisitor *visitor, AttrOrParam *a);
static void visitExplicitAssocAccess(MetaModelClassVisitor *visitor, ExplicitAssocAccess *a);
static void visitDataUnit(MetaModelClassVisitor *visitor, DataUnit *u);
static void visitMetaBasketDef(MetaModelClassVisitor *visitor, MetaBasketDef *d);
static void visitEnumNode(MetaModelClassVisitor *visitor, EnumNode *n);
static void visitRenamedBaseView(MetaModelClassVisitor *visitor, RenamedBaseView *v);
static void visitGraphic(MetaModelClassVisitor *visitor, Graphic *g);
static void visitDrawingRule(MetaModelClassVisitor *visitor, DrawingRule *r);
static void visitClass(MetaModelClassVisitor *visitor, Class *c);
static void visitBooleanType(MetaModelClassVisitor *visitor, BooleanType *b);
static void visitTextType(MetaModelClassVisitor *visitor, TextType *t);
static void visitBlackboxType(MetaModelClassVisitor *visitor, BlackboxType *t);
static void visitNumType(MetaModelClassVisitor *visitor, NumType *t);
static void visitCoordType(MetaModelClassVisitor *visitor, CoordType *t);
static void visitAnyOIDType(MetaModelClassVisitor *visitor, AnyOIDType *t);
static void visitAttributeRefType(MetaModelClassVisitor *visitor, AttributeRefType *t);
static void visitEnumType(MetaModelClassVisitor *visitor, EnumType *t);
static void visitEnumTreeValueType(MetaModelClassVisitor *visitor, EnumTreeValueType *t);
static void visitLineType(MetaModelClassVisitor *visitor, LineType *t);
static void visitMultiValue(MetaModelClassVisitor *visitor, MultiValue *v);
static void visitReferenceType(MetaModelClassVisitor *visitor, ReferenceType *t);
static void visitClassRefType(MetaModelClassVisitor *visitor, ClassRefType *t);
static void visitObjectType(MetaModelClassVisitor *visitor, ObjectType *t);
static void visitRole(MetaModelClassVisitor *visitor, Role *r);
static void visitUnit(MetaModelClassVisitor *visitor, Unit *r);
static void visitExplicitAssocAccess(MetaModelClassVisitor *visitor, ExplicitAssocAccess *t);
static void visitRenamedBaseView(MetaModelClassVisitor *visitor, RenamedBaseView *t);
static void visitDrawingRule(MetaModelClassVisitor *visitor, DrawingRule *t);
static void visitLineForm(MetaModelClassVisitor *visitor, LineForm *t);
static void visitFormattedType(MetaModelClassVisitor *visitor, FormattedType *t);
static void visitAttributeRefType(MetaModelClassVisitor *visitor, AttributeRefType *t);
static void visitRole(MetaModelClassVisitor *visitor, Role *t);
static void visitMetaObjectDef(MetaModelClassVisitor *visitor, MetaObjectDef *t);
static void visitLineType(MetaModelClassVisitor *visitor, LineType *t);
static void visitFunctionDef(MetaModelClassVisitor *visitor, FunctionDef *t);
static void visitArgument(MetaModelClassVisitor *visitor, Argument *t);

// helpers

static void display_debug(MetaModelClassVisitor *visitor, MMObject *o)
{
   string shortname;
   if (visitor == nullptr) {
      shortname = MMV;
...
void MetaModelClassVisitor::ignoreVisit()
{
...
static void visitClassRelatedType(MetaModelClassVisitor* visitor, ClassRelatedType* t)
{
...
static void visitBaseClass(MetaModelClassVisitor* visitor, BaseClass* c)
{
...
static void visitClassRestriction(MetaModelClassVisitor* visitor, ClassRestriction* r)
{
...
static void visitTransferElement(MetaModelClassVisitor* visitor, TransferElement* e)
{
...
static void visitIli1TransferElement(MetaModelClassVisitor* visitor, Ili1TransferElement* e)
{
...
static void visitAllowedInBasket(MetaModelClassVisitor* visitor, AllowedInBasket* b)
{
...
static void visitSimpleConstraint(MetaModelClassVisitor* visitor, SimpleConstraint* c)
{
...
static void visitAxisSpec(MetaModelClassVisitor* visitor, AxisSpec* s)
{
...
static void visitNumsRefSys(MetaModelClassVisitor* visitor, NumsRefSys* s)
{
...
static void visitARefRestriction(MetaModelClassVisitor* visitor, ARefRestriction* r)
{
...
static void visitLinesForm(MetaModelClassVisitor* visitor, LinesForm* f)
{
...
static void visitFactor(MetaModelClassVisitor* visitor, Factor* f)
{
...
static void visitExistenceDef(MetaModelClassVisitor* visitor, ExistenceDef* d)
{
...
static void visitExistenceConstraint(MetaModelClassVisitor* visitor, ExistenceConstraint* c)
{
...
static void visitUniqueConstraint(MetaModelClassVisitor* visitor, UniqueConstraint* c)
{
...
static void visitSetConstraint(MetaModelClassVisitor* visitor, SetConstraint* s)
{
...
static void visitDocText(MetaModelClassVisitor *visitor, DocText *t)
{
...
static void visitMetaAttribute(MetaModelClassVisitor *visitor, MetaAttribute *t)
{
...
static void visitMetaElement(MetaModelClassVisitor *visitor, MetaElement *t)
{
...
static void visitExtendableME(MetaModelClassVisitor *visitor, ExtendableME *t)
{
...
static void visitPackage(MetaModelClassVisitor *visitor, Package *t)
{
...
static void visitIli1Format(MetaModelClassVisitor *visitor, Ili1Format *t)
{
...
static void preVisitSubModel(MetaModelClassVisitor *visitor,SubModel *m)
{
...
static void postVisitSubModel(MetaModelClassVisitor *visitor,SubModel *m)
{
...
static void visitSubModel(MetaModelClassVisitor *visitor, SubModel *t)
{
...
static void visitMultiplicity(MetaModelClassVisitor *visitor, Multiplicity *t)
{
...
static void visitConstraint(MetaModelClassVisitor *visitor, Constraint *t)
{
...
static void visitDataUnit(MetaModelClassVisitor *visitor, DataUnit *t);

static void visitDomainType(MetaModelClassVisitor *visitor, DomainType *t)
{
...
static void visitTypeRelatedType(MetaModelClassVisitor *visitor, TypeRelatedType *t)
{
...
static void visitType(MetaModelClassVisitor *visitor, Type *t)
{
...
static void preVisitClass(MetaModelClassVisitor *visitor,Class *c)
{
...
static void postVisitClass(MetaModelClassVisitor *visitor,Class *c)
{
...
static void visitClass(MetaModelClassVisitor *visitor, Class *t)
{
...
static void visitExpression(MetaModelClassVisitor *visitor, Expression *t)
{
...
static void visitAttrOrParam(MetaModelClassVisitor *visitor, AttrOrParam *t)
{
...
static void visitTypeRestriction(MetaModelClassVisitor *visitor, TypeRestriction *t)
{
...
static void visitMultiValue(MetaModelClassVisitor *visitor, MultiValue *t)
{
...
static void visitAssocAcc(MetaModelClassVisitor *visitor, AssocAcc *t)
{
...
static void visitMetaBasketDef(MetaModelClassVisitor *visitor, MetaBasketDef *t);
...
static void visitContext(MetaModelClassVisitor *visitor, Context *t)
{
...
static void visitGenericDef(MetaModelClassVisitor *visitor, GenericDef *t)
{
...
static void visitUnit(MetaModelClassVisitor *visitor, Unit *t)
{
...
static void visitBooleanType(MetaModelClassVisitor *visitor, BooleanType *t)
{
...
static void visitEnumNode(MetaModelClassVisitor *visitor, EnumNode *t)
{
...
static void visitView(MetaModelClassVisitor *visitor, View *t)
{
...
static void visitUnaryExpr(MetaModelClassVisitor *visitor, UnaryExpr *t)
{
...
static void visitCompoundExpr(MetaModelClassVisitor *visitor, CompoundExpr *t)
{
...
static void visitPathEl(MetaModelClassVisitor *visitor, PathEl *t)
{
...
static void visitPathOrInspFactor(MetaModelClassVisitor *visitor, PathOrInspFactor *t)
{
...
static void visitEnumAssignment(MetaModelClassVisitor *visitor, EnumAssignment *t)
{
...
static void visitEnumMapping(MetaModelClassVisitor *visitor, EnumMapping *t)
{
...
static void visitClassRef(MetaModelClassVisitor *visitor, ClassRef *t)
{
...
static void visitActualArgument(MetaModelClassVisitor *visitor, ActualArgument *t)
{
...
static void visitFunctionCall(MetaModelClassVisitor *visitor, FunctionCall *t)
{
...
static void visitRuntimeParamRef(MetaModelClassVisitor *visitor, RuntimeParamRef *t)
{
...
static void visitConstant(MetaModelClassVisitor *visitor, Constant *t)
{
...
static void visitClassConst(MetaModelClassVisitor *visitor, ClassConst *t)
{
...
static void visitAttributeConst(MetaModelClassVisitor *visitor, AttributeConst *t)
{
...
static void visitUnitRef(MetaModelClassVisitor *visitor, UnitRef *t)
{
...
static void visitUnitFunction(MetaModelClassVisitor *visitor, UnitFunction *t)
{
...
static void visitGraphic(MetaModelClassVisitor *visitor, Graphic *t)
{
...
static void visitSignParamAssignment(MetaModelClassVisitor *visitor, SignParamAssignment *t)
{
...
static void visitCondSignParamAssignment(MetaModelClassVisitor *visitor, CondSignParamAssignment *t)
{
...
static void visitDocTextTranslation(MetaModelClassVisitor *visitor, DocTextTranslation *t)
{
...
static void visitMETranslation(MetaModelClassVisitor *visitor, METranslation *t)
{
...
static void visitTranslation(MetaModelClassVisitor *visitor, Translation *t)
{
...
static void visitImport(MetaModelClassVisitor *visitor, Import *i)
{
...
static void preVisitModel(MetaModelClassVisitor *visitor,Model *m)
{
...
static void postVisitModel(MetaModelClassVisitor *visitor,Model *m)
{
...
static void visitMMObject(MetaModelClassVisitor *visitor, MMObject *t)
{
...
static void preVisit(MetaModelClassVisitor *visitor)
{
...
static void postVisit(MetaModelClassVisitor *visitor)
{
...
static void visitAll(MetaModelClassVisitor *visitor)
{
...
void metamodel::MetaModelClassVisitor::visit(MMObject *o,string classname)
{
...
void metamodel::MetaModelClassVisitor::visit(MMObject *o)
{
   visit(o,o->getClass());
}
